...
class ErrorCode(str, Enum):
    ...
    PIPE_COSMIC_SATELLITE_FAILED = "PIPE_COSMIC_SATELLITE_FAILED"
    PIPE_GRAXPERT_DENOISE_FAILED = "PIPE_GRAXPERT_DENOISE_FAILED"
    PIPE_GRAXPERT_DECONV_FAILED = "PIPE_GRAXPERT_DECONV_FAILED"
    PIPE_STAR_SEPARATION_FAILED = "PIPE_STAR_SEPARATION_FAILED"
    PIPE_SIRILPY_SCRIPT_FAILED = "PIPE_SIRILPY_SCRIPT_FAILED"
    PIPE_ADAPTIVE_CRITIC_UNAVAILABLE = "PIPE_ADAPTIVE_CRITIC_UNAVAILABLE"
    PIPE_ADAPTIVE_CRITIC_INVALID_RESPONSE = "PIPE_ADAPTIVE_CRITIC_INVALID_RESPONSE"
